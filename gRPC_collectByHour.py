...
while time.time() < end_time:
    ...
    with open(f'dish-grpc-hour-{hour_counter}.txt', 'w') as f_starlinkScript, open(f'ping_hour-{hour_counter}.txt', 'w') as f_ping:
        ...
        while time.time() < hour_end_time:
            ...
            starlinkScript = os.popen('python3 dish_grpc_text.py -v status obstruction_detail alert_detail').read()
